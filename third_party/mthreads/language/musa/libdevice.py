"""MUSA libdevice mappings.

This module provides Triton externs bound to MUSA libdevice/intrinsics,
mirroring the CUDA libdevice API surface with MUSA-specific symbols.
"""
...
def trunc(arg0, _semantic=None):
    return core.extern_elementwise(
        "", "", [arg0], {
            (core.dtype("fp64"), ): ("__mt_trunc_f64", core.dtype("fp64")),
...
def exp2(arg0, _semantic=None):
    return core.extern_elementwise(
        "", "", [arg0], {
            (core.dtype("fp32"), ): ("__mt_exp2_f32", core.dtype("fp32")),
            (core.dtype("fp64"), ): ("__mt_exp2_f64", core.dtype("fp64")),
        }, is_pure=True, _semantic=_semantic)
...
def tanh(arg0, _semantic=None):
    return core.extern_elementwise(
        "", "", [arg0], {
            (core.dtype("fp32"), ): ("__mt_tanh_f32", core.dtype("fp32")),
            (core.dtype("fp64"), ): ("__mt_tanh_f64", core.dtype("fp64")),
        }, is_pure=True, _semantic=_semantic)
...
def erf(arg0, _semantic=None):
    return core.extern_elementwise(
        "", "", [arg0], {
            (core.dtype("fp32"), ): ("__mt_erf_f32", core.dtype("fp32")),
            (core.dtype("fp64"), ): ("__mt_erf_f64", core.dtype("fp64")),
        }, is_pure=True, _semantic=_semantic)
...
def ldexp(arg0, arg1, _semantic=None):
    return core.extern_elementwise(
        "", "", [arg0, arg1], {
            (core.dtype("fp32"), core.dtype("int32")): ("__mt_ldexp_f32", core.dtype("fp32")),
            (core.dtype("fp64"), core.dtype("int32")): ("__mt_ldexp_f64", core.dtype("fp64")),
        }, is_pure=True, _semantic=_semantic)
...
@core.extern
def fast_gelu(arg0, _semantic=None):
    return core.extern_elementwise("", "", [arg0], {
...
@core.extern
def fast_tanh(arg0, _semantic=None):
    return core.extern_elementwise("", "", [arg0], {
