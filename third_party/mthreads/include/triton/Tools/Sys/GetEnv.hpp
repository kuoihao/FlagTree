...
inline const std::set<std::string> CACHE_INVALIDATING_ENV_VARS = {
    ...
    "TRITON_MUSA_TOOLCHAIN_PATH",
    "TRITON_MUSA_LLC_PATH",
    "TRITON_MUSA_LLD_PATH",
    "TRITON_MUSA_LLC_ASM_PATH",
    "TRITON_MUSA_LLC_OPTIONS",
    "TRITON_MUSA_ENABLE_LLC_OPT",
    "TRITON_MUSA_ENABLE_FP8_BURST2",
    "TRITON_MUSA_ENABLE_LLVM_COMPAT",
    "TRITON_MUSA_DUMP_LLIR",
    "TRITON_MUSA_DUMP_MUASM",
    "TRITON_MUSA_REPLACE_LLIR",
    "TRITON_MUSA_REPLACE_MUBIN",
    "TRITON_MUSA_LIBDEVICE_PATH",
    "USE_IR_LOC",
    "NVPTX_ENABLE_DUMP",
