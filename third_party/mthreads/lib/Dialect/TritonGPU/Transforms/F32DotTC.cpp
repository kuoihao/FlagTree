...
bool isMusaTarget(Operation *op) {
  auto module = op ? op->getParentOfType<ModuleOp>() : nullptr;
  auto targetAttr =
      module ? module->getAttrOfType<StringAttr>(AttrTargetName) : nullptr;
